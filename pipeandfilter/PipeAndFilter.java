...
public class PipeAndFilter {
    public static void main(String[] args) {
        ...
        filters.add(PipeAndFilter::filterMultiplesOfThree);  // New filter added
    ...
    // New Filter: Remove numbers that are multiples of 3
    private static List<Integer> filterMultiplesOfThree(List<Integer> input) {
        return input.stream()
                .filter(n -> n % 3 != 0)
                .collect(Collectors.toList());
    }
